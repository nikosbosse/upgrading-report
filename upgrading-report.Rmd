...
Infectious disease modelling and forecasting can play a critical role in informing public health policy, as was once more highlighted by the COVID-19 pandemic. Improving infectious disease forecasting therefore is an important aim. Three questions are crucial: How can we best evaluate forecasts in order to learn from and improve on past predictions? What should the role of human insight be in infectious disease forecasting and how can we best combine human judgement with model-based inference? How can we best combine different predictions to an ensemble that performs better than any individual forecast. 


**Aim**

The aim of this PhD is to improve infectious disease forecasting and its usefulness to public health officials in the UK and other countries. In particular, it aims for a better understanding of how forecasts can best be evaluated, what role human insight should play in infectious disease forecasting and how single predictions can be aggregated to improve forecasting. 


**Objectives**

1. Establish appropriate tools to evaluate predictions in `R` and summarise best practices in forecast evaluation. Apply these tools to to evaluate short-term forecasts of COVID-19. 
2. Collect predictions of COVID-19 from humans in Germany, Poland using an `R shiny` app. Compare these human predictions against model-based forecasts to discern relative strengths and weaknesses of human forecasters vs. model-based approaches
...
paper1 <- data.frame(
  start = c(Sys.Date(), 
          ...
          "2022-08-15", 
          "2022-10-01"),
  content = c("Complete first Draft", 
              "Obtain feedback on draft", 
              "Rework draft", 
              "Internal peer review", 
              "Draft update and submission", 
              "Peer review", 
...
paper4 <- data.frame(
  start = c("2021-10-01", 
          ...
          "2023-04-01", 
          "2023-06-01"), 
  content = c("Analysis / Simulation Study", 
              "Write first draft", 
              "Obtain feedback on draft", 
              "Rework draft", 
              "Internal peer review", 
